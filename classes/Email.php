...
class Email {
    ...
    public function enviarConfirmacion() {
         ...
         // create a new object para envio de email
         $mail = new PHPMailer();
        //  isSMTP() este es el protococo de envio de email
        $mail->isSMTP();
        ...
        //  es lo que dice el email
         $mail->Subject = 'Confirma tu Cuenta';

         // Set HTML, le decimos que vamos utilizar HTML abajo
         $mail->isHTML(TRUE);
         $mail->CharSet = 'UTF-8';
